...
The `examples/` directory contains 16 reference test cases (`example0` through `example15`) covering basic primitives, multi-file packages, loops, lambdas, instance methods, stdin streaming, and pointer aliasing.
