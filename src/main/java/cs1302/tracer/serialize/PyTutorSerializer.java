        ...
        Map<String, Object> encodedLocals = stackSnapshot.visibleVariables().stream()
            .collect(
                Collectors.toMap(
                    ...
                    field -> serializeTraceValue(field.value(), heap, inlineStrings)
                ) // toMap
            );
    ...
    private static Object serializeTraceValue(
        ...
        return switch (value) {
            ...
            case TraceValue.Primitive.Float floatValue ->
                new JSONArray().put("NUMBER-LITERAL")
            ...
            case TraceValue.Primitive.Character charValue ->
                new JSONArray().put("CHAR-LITERAL")
                    .put(Character.toString(charValue.value()));

            case TraceValue.Primitive primitiveValue ->
                primitiveValue.toWrapperObject();
            ...
            case TraceValue.Null nullValue
                -> JSONObject.NULL;
