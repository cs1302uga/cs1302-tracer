# Example 34: Start and join

Both workers print `2`, and `joined` follows both. Compare their distinct thread IDs and stacks. Worker event order can vary.
...
java -jar target/code-tracer-jar-with-dependencies.jar trace \
  -i examples/example34/Driver.java --multithread --format modern \
